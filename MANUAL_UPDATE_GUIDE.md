...
```bash
# 1. 拉取指定版本镜像
docker pull a3180623/dokploy-i18n:v0.28.8-i18n.8

# 2. 更新服务
docker service update --force --image a3180623/dokploy-i18n:v0.28.8-i18n.8 dokploy

# 3. （可选）如果要固定使用这个版本，设置环境变量
docker service update --env-add RELEASE_TAG=v0.28.8-i18n.8 dokploy
...
# 升级到指定版本
DOKPLOY_VERSION=v0.28.8-i18n.8 bash install.sh update
```
